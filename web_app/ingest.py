...
def create_vector_store(
        documents, vector_store_path: str = '../vector_store'
) -> Chroma:
    ...
    # The vector store can be persisted to (and loaded from) disk by calling vector_store.persist() (and SimpleVectorStore.from_persist_path(...) respectively)
...
def get_parser():
    ...
    parser.add_argument(
        "--prompt_file",
        type=pathlib.Path,
        default="../files/chat_prompt.json",
